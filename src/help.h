...
struct commandHelp {
  ...
  char *since;
    ...
    "2.8.9" },
    { "ZRANGEBYLEXIN",
    "key is_reverse_order min_lexical_value max_lexical_value offset limit asc_prefix1 [ asc_prefix2 [ ... asc_prefixN ] ]",
    "Return a range of members in a sorted set, by multiple lexicographical ranges constrained by prefix withIN {asc_prefix1, asc_prefix2, ..., asc_prefixN} and the rest(prefix stripped) within lexicographical range from min_lexical_value to max_lexical_value, is_reverse_order can be [0+<Aa] to indicate ASC order, otherwise DESC order, limit can be less than 1 to indicate that there is no limit",
    4,
    "forked_version_since_2.8.9" },
    { "ZRANGEBYSCORE",
